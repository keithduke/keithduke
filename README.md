...
- 🔧 **T.O.M. (Terminal Orchestrated Model) Framework**  
  ...
  → [`TOM-framework`](https://github.com/keithduke/TOM-framework)

- 🌐 **Personal Website**  
  A small, fast site built with Vite and GitHub Pages, serving as my long-form “About” and project hub.  
  → [`keithduke.github.io`](https://github.com/keithduke/keithduke.github.io) · [Live site](https://www.keithduke.net)
...
- 🕹️ **Roguelike Dungeon Crawler**  
  ...
  → [Play it here](https://headtrip.media)

- ⚙️ **Dotfiles**  
  Editor and shell setup I actually use day-to-day.  
  → [`dotfiles`](https://github.com/keithduke/dotfiles)
...
- 🏠 Website: [keithduke.net](https://www.keithduke.net)  
- ✍️ Writing: [Here Lately](https://www.herelately.com)  
- 💼 LinkedIn: [linkedin.com/in/keith-duke-8488345](https://www.linkedin.com/in/keith-duke-8488345)  
...
<!--
**keithduke/keithduke** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
